...
public class IfcXmlParser : MonoBehaviour {
    ...
    public static void parseXmlFile(string xml_path, GameObject ifcRootGameObject = null, IfcSettingsOptionHolder options = null){
        if (options == null) {
    ...
    private static void ParseIfcHierarchy(XmlNodeList nlist, IfcRootLists ifcRootList, GameObject parent, IfcSettingsOptionHolder options){
        ...
        foreach(XmlNode node in nlist){
            ...
            if((node.Attributes["id"] != null && GameObject.Find(node.Attributes["id"].InnerText)) || node.Name == "IfcProject" ){
                ...
                if (options.meshCollidersEnabled)
                {
    ...
    public static bool CheckMenuCondition(string menuOption, IfcSettingsOptionHolder options)
    {
